...
namespace KegID.Droid.DependencyServices
{
    public class PermissionAndroid : IPermission
    {
        ...
        public Task<bool> VerifyStoragePermissions()
        {
            ...
            Permission permission = AndroidX.Core.Content.ContextCompat.CheckSelfPermission(CrossCurrentActivity.Current.AppContext, Manifest.Permission.WriteExternalStorage);
